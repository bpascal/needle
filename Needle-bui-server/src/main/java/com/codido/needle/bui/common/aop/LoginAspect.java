...
import com.codido.needle.bui.common.bean.req.BaseReq;
import com.codido.needle.bui.common.exception.LoginException;
...
public class LoginAspect {
     ...
     * ~ .. 匹配任意数量的参数.
     */
    @Pointcut("@annotation(com.codido.needle.bui.common.annotation.AreYouLogin)")

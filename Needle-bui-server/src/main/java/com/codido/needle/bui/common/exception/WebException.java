package com.codido.needle.bui.common.exception;

import com.codido.needle.bui.common.bean.resp.BaseResp;
import com.codido.needle.bui.common.constans.BuiConstans;
...
public class WebException {
    ...
    public BaseResp exeMethodArgEcp(MethodArgumentNotValidException exception) {
        ...
        if (!JBUtil.isListEmpty(errors)) {
            ...
            errorMsgStr = BuiConstans.RESP_MSG_PARAM_ERROR;
        }
        BaseResp baseResp = new BaseResp();
        baseResp.setRespCode(BuiConstans.RESP_CODE_PARAM_ERROR);
    ...
    public BaseResp jsonErrorHandler(HttpServletRequest req, LoginException e) throws Exception {
        ...
        resp.setRespCode(BuiConstans.RESP_CODE_TOKEN_ERROR);
        resp.setRespMsg(BuiConstans.RESP_MSG_TOKEN_ERROR);
        return resp;
    }
    ...
    public BaseResp execp(Exception exception) {
        ...
        BaseResp baseResp = new BaseResp();
        baseResp.setRespCode(BuiConstans.RESP_CODE_OTHER_ERROR);
        baseResp.setRespMsg(BuiConstans.RESP_MSG_OTHER_ERROR);
        return baseResp;
    }
}

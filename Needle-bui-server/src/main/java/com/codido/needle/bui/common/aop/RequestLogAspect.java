package com.codido.needle.bui.common.aop;


import com.codido.needle.bui.common.util.JsonUtils;
import com.codido.needle.bui.common.util.LogUtil;
import com.codido.needle.core.common.util.OrderNoGeneratorUtil;
...
public class RequestLogAspect {
     ...
     * ~ .. 匹配任意数量的参数.
     */
    @Pointcut("execution(public * com.codido.needle.bui.*.controller..*.*(..))")

package com.codido.needle.api.common.aop;


import com.codido.needle.api.common.util.JsonUtils;
import com.codido.needle.api.common.util.LogUtil;
...
public class RequestLogAspect {
     ...
     * ~ .. 匹配任意数量的参数.
     */
    @Pointcut("execution(public * com.codido.needle.api.*.controller..*.*(..))")

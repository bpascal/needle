...
import com.codido.needle.api.common.bean.req.BaseReq;
import com.codido.needle.api.common.exception.LoginException;
...
public class LoginAspect {
     ...
     * ~ .. 匹配任意数量的参数.
     */
    @Pointcut("@annotation(com.codido.needle.api.common.annotation.AreYouLogin)")
